...
int main(){ 
    ...
    // Solution sol;
    // sol.isSymmetric(root)?(cout << "true" << endl):(cout << "false" << endl);

    // RecursiveSolution rsol;
    // rsol.isSymmetric(root)?(cout << "true" << endl):(cout << "false" << endl);

    IterativeSolution isol;
    isol.isSymmetric(root)?(cout << "true" << endl):(cout << "false" << endl);
